function m_opts= run_config(paths)
    ...
    save_pc_files = strcat(m_directory,job_net,'_to_',test_on,'_',int2str(f_dimension),'_',proj);
    save_mdl_pc_files = strcat(m_directory,'precomputed_files/',job_net,'_to_',m_on,'_',int2str(f_dimension),'_',proj);
    save_mdl_pc = strcat(m_directory,'models/',job_net,'_to_',m_on,'_',int2str(f_dimension),'_data.mat');
    save_mdl = strcat(m_directory,'models/', job_net,'_to_',m_on,'_',int2str(f_dimension),'_mdls.mat');
    save_precomputed_files = strcat(m_directory,'precomputed_files/',job_net,'_to_',test_on,'_',int2str(f_dimension));

    save_pc_files_all = strcat(m_directory,job_net,'_to_',test_on,'_box_50_plus','.mat');
    ...
    m_opts = struct(...
                ...
                'save_pc_files',                save_pc_files, ...
                'save_results',             save_results, ...
                'save_pc_files_all',            save_pc_files_all, ...
                'save_precomputed_files', save_precomputed_files, ...
                'm_limit',                  m_limit, ...
                'save_mdl_pc_files',                save_mdl_pc_files, ...
                'm_alpha',                  m_alpha, ...
                'save_mdl_pc',              save_mdl_pc, ...
                'save_mdl',          save_mdl, ...
